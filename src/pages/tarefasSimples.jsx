    ...
    return( 
        <div className="container mt-5" style={{ maxWidth: "500px" }}>
            ...
            <div className="input-group mb-3">
                <input type="text" className="form-control" placeholder="Digite a nova tarefa" value={novaTarefa}
            ...
            <ul className="list-group">
                ...
                {listaDeTarefas.map((tarefa, posicaoNoIndex) => (
                    <li key={posicaoNoIndex} className="list-group-item d-flex justify-content-between">
                        {tarefa}
                        <button className="btn btn-danger btn-sm" onClick={() => removerTarefa(posicaoNoIndex)}> Remover </button>
                    </li>
                ))}
            </ul>
        </div>
